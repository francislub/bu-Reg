...
export function StudentTimetable({ userId }: StudentTimetableProps) {
  ...
  if (!timetableData) {
    return (
      <Alert>
        ...
        <AlertDescription>
          There is no published timetable for your registered courses this semester. Please check back later or contact
    ...
    <Card>
      ...
      <CardContent>
        <div className="hidden print:block text-center mb-4">
          ...
          <p className="text-lg">Student Schedule</p>
        </div>
