...
export function ProfileForm({ initialData }: ProfileFormProps) {
  ...
  const form = useForm<ProfileFormValues>({
    ...
    defaultValues: {
      ...
      dateOfBirth: initialData?.profile?.dateOfBirth ? new Date(initialData.profile.dateOfBirth) : new Date(),
      gender: initialData?.profile?.gender || "Male",
      nationality: initialData?.profile?.nationality || "uganda",
      maritalStatus: initialData?.profile?.maritalStatus || "Single",
      religion: initialData?.profile?.religion || "seventh-day-adventist",
      church: initialData?.profile?.church || "",
      responsibility: initialData?.profile?.responsibility || "",
      referralSource: initialData?.referralSource || "friend",
      physicallyDisabled: initialData?.profile?.physicallyDisabled || false,
    },
  })
  ...
  async function onSubmit(data: ProfileFormValues) {
    ...
    try {
      ...
      if (result.success) {
        ...
        toast({
          title: "Update Failed",
          description: result.message || "There was a problem updating your profile. Please try again.",
          variant: "destructive",
        })
      }
    } catch (error: any) {
